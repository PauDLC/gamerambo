...
export default class SeleccionNivel extends Phaser.Scene {  
    ...
    create (): void {      
        ...
        const nivel1Txt: Phaser.GameObjects.BitmapText  = this.add.bitmapText(100, 100 , Constantes.FUENTES.BITMAP, Constantes.ESCENAS.NIVEL1, 15).setInteractive();
        this.cambiarEscena(nivel1Txt, Constantes.ESCENAS.NIVEL1);
        this.escribirMejorPuntuacion(nivel1Txt);
        
        const nivel2Txt: Phaser.GameObjects.BitmapText  = this.add.bitmapText(100, 200 , Constantes.FUENTES.BITMAP, Constantes.ESCENAS.NIVEL2, 15).setInteractive();
        this.cambiarEscena(nivel2Txt, Constantes.ESCENAS.NIVEL2);
        this.escribirMejorPuntuacion(nivel2Txt);
        
        
        const nivel3Txt: Phaser.GameObjects.BitmapText  = this.add.bitmapText(100, 300 , Constantes.FUENTES.BITMAP, Constantes.ESCENAS.NIVEL3, 15).setInteractive();
    ...
    escribirMejorPuntuacion(nivelTxt: Phaser.GameObjects.BitmapText): void{
        ...
        if (this.mibd.datos.puntuaciones[nivelbd] > 0){
            ...
            const nivelPuntuacion : Phaser.GameObjects.BitmapText = this.add.bitmapText(nivelTxt.x + 200, nivelTxt.y , Constantes.FUENTES.BITMAP, mejorResultado , 15);
        }
